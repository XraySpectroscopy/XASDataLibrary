...
CREATE TABLE person (
	...
	notes VARCHAR(65535), 
	attributes VARCHAR(65535), 
	first_name VARCHAR(65535) NOT NULL, 
	last_name VARCHAR(65535) NOT NULL, 
	PRIMARY KEY (id), 
	UNIQUE (email)
);
CREATE TABLE format (
...
CREATE TABLE sample (
	...
	notes VARCHAR(65535), 
	attributes VARCHAR(65535), 
	formula VARCHAR(65535), 
	material_source VARCHAR(65535), 
	person INTEGER, 
	crystal INTEGER, 
	PRIMARY KEY (id), 
	UNIQUE (name), 
...
CREATE TABLE spectra (
	...
	notes VARCHAR(65535), 
	attributes VARCHAR(65535), 
	file_link VARCHAR(65535), 
	dat_energy VARCHAR(65535), 
	dat_i0 VARCHAR(65535), 
	dat_itrans VARCHAR(65535), 
	dat_iemit VARCHAR(65535), 
	dat_irefer VARCHAR(65535), 
	dat_dtime_corr VARCHAR(65535), 
	calc_mu_trans VARCHAR(65535), 
	calc_mu_emit VARCHAR(65535), 
	calc_mu_refer VARCHAR(65535), 
	calc_energy_ev VARCHAR(65535), 
	notes_energy VARCHAR(65535), 
	notes_i0 VARCHAR(65535), 
	notes_itrans VARCHAR(65535), 
	notes_iemit VARCHAR(65535), 
	notes_irefer VARCHAR(65535), 
	temperature VARCHAR(65535), 

...
Using the conventions of the XAS community, the energies here are recorded
in electron-Volts (:math:`eV`) and values for absorption are left
"un-normalized" - not necessarily scaled to any particular units.  Most of
the data will has been measured in Transmission mode, though some has been
measured in Fluorescence or other Emission modes.
